...
public class WorkDayOrganizer implements Organizer {
    ...
    public WorkDayOrganizer(Day day) {
        ...
        this.day = day;
                                                                                ...
                                                                                //TODO brake formDay() to another small services
    @Override
    public void formDay() {
    ...
    public boolean isBetweenStartEndOfDay(LocalTime time) {
        return time.getHour() >= day.getStartOfDay().getHour() && time.isBefore(day.getEndOfDay()); // TODO it`s not WorkDayOrganizer`s responsibility
    }
    ...
    private boolean enoughTimeForActivity(LocalTime startTime, Activity activity) {     // TODO you have to reconstruct this method in more simple way
        int duration = activity.getDuration().getHour();                                // TODO without map , just by using Lists
